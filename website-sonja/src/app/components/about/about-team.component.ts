      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div 
          *ngFor="let member of teamMembers"
          [ngClass]="getCardClasses(member.color)"
        ...
        >
          <div [ngClass]="getGlowClasses(member.color)" class="absolute -top-10 -right-10 w-32 h-32 blur-3xl rounded-full group-hover:transition-colors duration-500"></div>

          <div class="relative z-10">
            <div class="aspect-square rounded-xl bg-gray-50 dark:bg-gray-800 mb-5 overflow-hidden shadow-inner border border-gray-50 dark:border-white/5">
            ...
            <div [ngClass]="getTitleClasses(member.color)" class="text-[9px] font-black uppercase tracking-[0.2em] mb-3">
              {{ member.title }}
            </div>
...
export class AboutTeamComponent {
  teamMembers: TeamMember[] = [
    ...
    },
    {
      ...
      description: '„Feedback basiert überwiegend auf Blicken. Positive Bewertung wird durch Schnurren signalisiert."',
      image: 'mia_sam.jpeg',
      color: 'purple',
    },
    {
      ...
      description: '„Verantwortlich für Pausen, Motivation und regelmäßige Spaziergang-Erinnerungen."',
      image: 'lio.jpeg',
      color: 'green',
    },
  ];
